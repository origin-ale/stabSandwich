...
evs = campspp_circuit_dynamics(ψ, χ_campspp, thl_campspp, Nmax_campspp, gates, phases, obs, output; showprogress = true, obsname = "magnetization", ev_at = end_xxz)

open(output, "a") do f
  println(f, "\n")
end
_ = camps_circuit_dynamics(ψ, χ_camps, gates, phases, obs, output; showprogress = true, ev_at = end_xxz)
...
_ = pauliprop_circuit_dynamics(ψ, 0, thl_pp, gates, angles, Nmax_pp, obs, output; showprogress = true, ev_at = end_xxz)
return