...
#
# Input: output/carlos_varseed/resources_prob_tm_*_campspp.txt as written by
...
datafile = "output/carlos_varseed/resources_prob_tm_NP_campspp.txt"
...
# == Bond dimension =====================================================================
datafile = "output/carlos_varseed/resources_prob_tm_bd_campspp.txt"
load "plotting/box_setup.plt"
