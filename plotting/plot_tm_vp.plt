...
set output "output/TMD_".N."_".magic_prob."gl_".Nsamples."_graph.png"
...
set key font ",16"
plot for [i = 0:3] "output/TMD_".N."_".magic_prob."gl_".Nsamples.".txt" index i with yerrorlines title "µ = ".mus[i+1] ,\
x**0.66 title "t^{2/3}" lc rgb "dark-gray",\
2*x title "2t (upper bound)" lc rgb "red"
print "Plotted output/TMD_".N."_".magic_prob."gl_".Nsamples.".txt"
